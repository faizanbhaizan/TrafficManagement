...
public:
  ...
  int delay()
    ...
    int trafContBooth()
    {
        ...
        cout<<"*                     Press Your Option :-                                                                                            *"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                                      1. Greater Noida Traffic Control Booth                                                             *"<<endl;
        cout<<"*                                      2. Noida Traffic Control Booth                                                              *"<<endl;
        cout<<"*                                      3. Ghaziabad Traffic Control Booth                                                            *"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                     Enter 0 For Home                                                                                                *"<<endl;
        cout<<"*                     Enter your choice __                                                                                            *"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
    ...
    int trafContBooth_1()
    {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            cout<<"                     Greater Noida Traffic Control Booth                 "<<endl;
    ...
    int trafContBooth_2()
    {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            cout<<"                      Noida Traffic Control Booth                 "<<endl;
            cout<<"Vehicles Going out of the City                   Vehicles coming into the City"<<endl;
    ...
    int trafContBooth_3()
    {
        ...
        for (int i = 0; i < 100; ++i) {
            ...
            cout<<"                      Ghaziabad Traffic Control Booth                 "<<endl;
            cout<<"Vehicles Going out of the City                   Vehicles coming into the City"<<endl;
    ...
    int helpInfo()
    {
        ...
        cout<<"*                                      2. Hospitals in Noida/GreaterNoida                                                                       *"<<endl;
        cout<<"*                                      3. Hospitals in Ghaziabad                                                                     *"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
        cout<<"*                     Enter 0 For Home                                                                                                *"<<endl;
        cout<<"*                     Enter your choice __                                                                                            *"<<endl;
        cout<<"*                                                                                                                                     *"<<endl;
